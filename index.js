...
const allowedOrigins = [
    ...
    "http://localhost:5175",
    "http://localhost:3000",
    "https://wedding-photography-app-frontend.vercel.app",
    "https://wedding-photography-app-frontend-airw8ym5a.vercel.app"
];
...
app.use(cors({
    origin: function (origin, callback) {
        ...
        const isAllowed = allowedOrigins.includes(origin) || 
                          (origin.startsWith("https://wedding-photography-app-frontend") && origin.endsWith(".vercel.app"));
